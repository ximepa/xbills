...
from django.db.models.fields.related import ForeignKey, ForwardManyToOneDescriptor, ManyToManyDescriptor
try:
    from django.db.models.fields.related_descriptors import ReverseManyToOneDescriptor, ReverseManyToOneDescriptor, ReverseOneToOneDescriptor
except ImportError:
    from django.db.models.fields.related import ReverseManyRelatedObjectsDescriptor, ForeignRelatedObjectsDescriptor, SingleRelatedObjectDescriptor
