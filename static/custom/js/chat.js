$(document).ready(function($) {
	...
	function receiveMessage(msg) {
		...
		if (global_chat.length == 1) {
			global_chat.append($('<div/>').addClass('active item').append(comments.append(comment.append(content))));
			global_chat.scrollTop(global_chat.scrollTop() + comments.height() + comments.height());
		}
	}
