...
semantic.ready = function() {
  ...
  handler = {
    ...
    getMetadata: function() {
      $.api({
        debug : false,
        on    : 'now',
        url   : 'http://semantic-ui.com/metadata.json',
        cache : 'local',
  ...
  $.extend($.fn.api.settings.api, {
    ...
    getOverrides       : '/static/semantic-ui/themes/{$theme}/{$type}s/{$element}.overrides',
    getVariables       : '/static/semantic-ui/themes/{$theme}/{$type}s/{$element}.variables',
